...
BR_URL = "https://api.baserow.io/api/"
...
class BaserowClient:
    ...
    def is_token_valid(self):
        if self.__token_status__ == 200:
            return "Congratulations! You got yourself a token!"
        return "Token authentication failed. You can still use some functions that do not require authentication."
